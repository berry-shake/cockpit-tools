...
mod tests {
    use super::{
        has_enabled_periodic_account_refresh, should_apply_startup_minimized,
        should_hide_startup_minimized_window, should_preserve_main_window_for_background_refresh,
