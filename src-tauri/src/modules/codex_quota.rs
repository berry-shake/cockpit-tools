...
async fn fetch_subscription_account_check(
    ...
    let client =
        crate::modules::codex_proxy_runtime::client_builder(account, reqwest::Client::builder())
            .await?
            .build()
            .map_err(|_| "PROXY_CLIENT_FAILED")?;
    let headers =
...
async fn send_codex_api_request_with_agent_auth_base_url(
    ...
    let client = crate::modules::codex_proxy_runtime::client_builder(
        account,
